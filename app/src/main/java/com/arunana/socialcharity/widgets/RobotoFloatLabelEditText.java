...
public class RobotoFloatLabelEditText extends LinearLayout {
    ...
    public RobotoFloatLabelEditText(Context context) {
        super(context);
        mContext = context;
        initialize();
    }

    public RobotoFloatLabelEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setAttributes(attrs);
        initialize();
    ...
    public RobotoFloatLabelEditText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.FloatLabelEditText);
        inputType = EditorInfo.TYPE_NULL;
        try {
            hint = a.getString(R.styleable.FloatLabelEditText_fletFloatingHint);
            inputType = a.getInt(R.styleable.FloatLabelEditText_fletInputType, EditorInfo.TYPE_NULL);
            imeOptions = a.getInt(R.styleable.FloatLabelEditText_fletImeOptions, EditorInfo.IME_ACTION_DONE);
            imeActionId = a.getInt(R.styleable.FloatLabelEditText_fletImeActionId, -1);
            imeActionLabel = a.getString(R.styleable.FloatLabelEditText_fletImeActionLabel);
            singleLine = a.getBoolean(R.styleable.FloatLabelEditText_fletSingleLine, false);
            hintColor = a.getColorStateList(R.styleable.FloatLabelEditText_fletHintTextColor);
            textColor = a.getColorStateList(R.styleable.FloatLabelEditText_fletTextColor);
        } finally {
            a.recycle();
        }
    }
    ...
    private void initialize() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.widget_float_label_edit_text, this);

        hintTextView = (TextView) view.findViewById(R.id.FloatLabelEditTextHint);
        editText = (EditText) view.findViewById(R.id.FloatLabelEditTextEditText);
